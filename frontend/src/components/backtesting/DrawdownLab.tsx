...
const drawdownHistory = [
  { name: "Month 1", drawdown: 0 },
  { name: "Month 2", drawdown: -1.25 },
  { name: "Month 3", drawdown: -3.12 },
  { name: "Month 4", drawdown: -0.50 },
  { name: "Month 5", drawdown: 0 }
];

export const DrawdownLab = () => {
  return (
    <div className="space-y-4">
      <h4 className="text-xs font-bold uppercase tracking-wider text-white">Simulator Drawdown Underwater Chart</h4>
