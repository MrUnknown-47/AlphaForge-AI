...
export const MonteCarloInstitutional = () => {
  return (
    <div className="space-y-4">
      <h4 className="text-xs font-bold uppercase tracking-wider text-white">Monte Carlo Simulation Paths (10000 Iterations)</h4>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs font-semibold text-mutedCustom bg-secondaryBg bg-opacity-20 border border-borderCustom rounded p-4 uppercase">
        ...
        <div>
          ...
          <span className="block text-white font-mono mt-1">$9.4M - $14M</span>
        </div>
      </div>
    </div>
  );
};
export default MonteCarloInstitutional;
