...
export const CIOAgent: React.FC = () => {
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center border-b border-borderCustom pb-2">
        <h4 className="text-xs font-bold uppercase tracking-wider text-white">Sentiment Agent Card</h4>
      ...
      <div className="bg-secondaryBg bg-opacity-20 border border-borderCustom rounded p-4 space-y-3 text-xs font-semibold text-mutedCustom">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <span className="block text-white font-mono mt-0.5">82%</span>
          </div>
          <div>
            <span className="text-[10px] uppercase block tracking-wider">Score</span>
            <span className="block text-accentCustom font-mono mt-0.5">8.2 / 10</span>
          </div>
        </div>
        ...
        <div className="border-t border-borderCustom pt-2">
          ...
          <p className="text-white font-normal text-[11px] leading-relaxed">
            Social media platforms and analyst rating aggregators indicate high net positive sentiment scores. News momentum flow maps bullish targets.
          </p>
        </div>
      </div>
    </div>
