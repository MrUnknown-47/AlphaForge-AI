...
export const TradeExplainer = () => {
  return (
    <div className="space-y-4">
      <h4 className="text-xs font-bold uppercase tracking-wider text-white">Explainability & SHAP Diagnoses</h4>

      <div className="bg-secondaryBg bg-opacity-20 border border-borderCustom rounded p-4 space-y-4 text-xs">
        <div>
          <span className="block font-bold text-accentCustom uppercase mb-1">Decision Attribution Thesis</span>
          <p className="text-mutedCustom leading-relaxed">
            The ensemble model predicts long expansion signals for AAPL and NVDA based on technical trend indicators.
          </p>
        </div>
