...
// Widgets import
import ResearchCommand from "../../components/research/ResearchCommand";
import SearchEngine from "../../components/research/SearchEngine";
import KnowledgeGraph from "../../components/research/KnowledgeGraph";
import SECResearch from "../../components/research/SECResearch";
import EarningsResearch from "../../components/research/EarningsResearch";
import QuantLibrary from "../../components/research/QuantLibrary";
import RAGAnswer from "../../components/research/RAGAnswer";
import Timeline from "../../components/research/Timeline";
import ResearchNotebook from "../../components/research/ResearchNotebook";
import ResearchAgents from "../../components/research/ResearchAgents";
import AlphaDiscovery from "../../components/research/AlphaDiscovery";
import KnowledgeManager from "../../components/research/KnowledgeManager";
...
export default function ResearchPage() {
  ...
  if (loading) {
    return <LoadingScreen message="Resolving quantitative RAG index pools..." />;
  }
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <header className="h-16 bg-secondaryBg border-b border-borderCustom flex items-center justify-between px-6">
            <div className="flex items-center gap-4">
              <SearchBar placeholder="Press Ctrl+K or type query..." onClick={() => setCmdOpen(true)} readOnly />
            </div>
          ...
          <main className="flex-1 overflow-y-auto p-6 space-y-6">
            <div>
              <h2 className="text-2xl font-bold uppercase tracking-wider text-white">Research RAG Terminal & Knowledge Graph</h2>
              <p className="text-xs text-mutedCustom mt-1">Cross-referencing SEC filings, earnings calls, and factor datasets.</p>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
              ...
              <div className="xl:col-span-8 space-y-6">
                <div className="bg-cardBg border border-borderCustom rounded p-5 shadow-lg">
                  <ResearchCommand onSearch={setSearchQuery} />
                </div>
                <div className="bg-cardBg border border-borderCustom rounded p-5 shadow-lg">
                  <SearchEngine query={searchQuery} />
                </div>
                <div className="bg-cardBg border border-borderCustom rounded p-5 shadow-lg">
                  <RAGAnswer query={searchQuery} />
                </div>
                <div className="bg-cardBg border border-borderCustom rounded p-5 shadow-lg">
                  <QuantLibrary />
                </div>
