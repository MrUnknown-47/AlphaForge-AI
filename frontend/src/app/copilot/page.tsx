...
// Widgets import
import AgentControlCenter from "../../components/copilot/AgentControlCenter";
import ChatWorkspace from "../../components/copilot/ChatWorkspace";
import MarketIntelligence from "../../components/copilot/MarketIntelligence";
import PortfolioManager from "../../components/copilot/PortfolioManager";
import TradeExplainer from "../../components/copilot/TradeExplainer";
import QuantResearch from "../../components/copilot/QuantResearch";
import RiskIntelligence from "../../components/copilot/RiskIntelligence";
import StrategyResearch from "../../components/copilot/StrategyResearch";
import RAGResearch from "../../components/copilot/RAGResearch";
import CIOAgent from "../../components/copilot/CIOAgent";
...
export default function CopilotPage() {
  ...
  if (loading) {
    return <LoadingScreen message="Resolving RAG index vectors databases..." />;
  }
  ...
  const commands = [
    ...
    { category: "Navigation", label: "Go to Optimization Lab", action: () => router.push("/optimization") }
  ];
        ...
        <aside className="w-64 bg-secondaryBg border-r border-borderCustom flex flex-col justify-between">
          <div>
            ...
            <nav className="mt-4 px-3 space-y-1">
              {[
                { name: "Copilot Hub", icon: "🤖", path: "/copilot" },
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <header className="h-16 bg-secondaryBg border-b border-borderCustom flex items-center justify-between px-6">
            <div className="flex items-center gap-4">
              <SearchBar placeholder="Press Ctrl+K or ask copilot..." onClick={() => setCmdOpen(true)} readOnly />
            </div>
          ...
          <main className="flex-1 overflow-y-auto p-6 space-y-6">
            <div>
              <h2 className="text-2xl font-bold uppercase tracking-wider text-white">AI Copilot & Multi-Agent Research Desk</h2>
              <p className="text-xs text-mutedCustom mt-1">Institutional quantitative advisor team.</p>
            </div>
