...
// Widgets import
import AssetUniverse from "../../components/multiasset/AssetUniverse";
import OptionsDesk from "../../components/multiasset/OptionsDesk";
import FuturesDesk from "../../components/multiasset/FuturesDesk";
import FXDesk from "../../components/multiasset/FXDesk";
import CryptoDesk from "../../components/multiasset/CryptoDesk";
import CrossAssetRisk from "../../components/multiasset/CrossAssetRisk";
import MacroAllocation from "../../components/multiasset/MacroAllocation";
...
export default function MultiAssetPage() {
  ...
  if (loading) {
    return <LoadingScreen message="Linking global exchanges multi-asset feeds..." />;
  }
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <header className="h-16 bg-secondaryBg border-b border-borderCustom flex items-center justify-between px-6">
            <div className="flex items-center gap-4">
              <SearchBar placeholder="Press Ctrl+K or search multi-asset universe..." onClick={() => setCmdOpen(true)} readOnly />
            </div>
          ...
          <main className="flex-1 overflow-y-auto p-6 space-y-6">
            <div>
              <h2 className="text-2xl font-bold uppercase tracking-wider text-white">Multi-Asset Trading & Strategy Terminal</h2>
              <p className="text-xs text-mutedCustom mt-1">Cross-market listings, options structures, forex carries, futures rollover, and crypto perpetuals.</p>
            </div>
